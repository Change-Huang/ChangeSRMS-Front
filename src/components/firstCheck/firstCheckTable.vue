<template>
  <el-table :data="firstCheckList" size="mini" :max-height="tableHeight" v-loading="tableLoading"
    border>
    ...
    <el-table-column label="初审人员" prop="adminNickname"></el-table-column>
    <!-- 相关操作列 -->
